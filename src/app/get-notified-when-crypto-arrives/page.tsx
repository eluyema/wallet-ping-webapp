      ...
      <main className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16 animate-fadeIn">
          <div className="inline-block mb-4">
            <span className="px-4 py-2 bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-500/30 rounded-full text-sm text-purple-300 font-medium flex items-center gap-2">
          ...
          <p className="text-xl sm:text-2xl text-gray-300 mb-4 max-w-3xl mx-auto leading-relaxed">
            The future of calm Ethereum notifications
          </p>
          <p className="text-lg text-gray-400 mb-6 max-w-2xl mx-auto">
            Track manually now • Automatic notifications coming soon
          </p>
          <p className="text-sm text-gray-500 mb-10">
            Currently supports Ethereum (ETH) • More chains coming
          </p>
        </div>
