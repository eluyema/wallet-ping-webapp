...
export default function NotificationMockup({ type }: NotificationMockupProps) {
  if (type === 'email') {
    return (
      <div className="aspect-video bg-gradient-to-br from-purple-500/10 to-pink-500/10 rounded-xl border border-purple-500/30 flex items-center justify-center p-6">
        <div className="max-w-sm bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg p-4">
  ...
  if (type === 'sms') {
    return (
      <div className="aspect-video bg-gradient-to-br from-cyan-500/10 to-blue-500/10 rounded-xl border border-cyan-500/30 flex items-center justify-center p-6">
        <div className="max-w-xs bg-cyan-500/20 backdrop-blur-sm border border-cyan-500/30 rounded-lg p-4">
  ...
  // bell
  return (
    <div className="aspect-video bg-gradient-to-br from-gray-800/50 to-gray-900/50 rounded-2xl border border-gray-700/50 flex flex-col items-center justify-center p-8 text-center">
